...
class BackendAgent(BaseAgent):
    ...
    def __init__(self, agent_id: str = None, name: str = "Backend Agent"):
        ...
        # Template system
        self.template_base_path = Path(__file__).parent.parent.parent / "templates" / "backend"
        self.api_templates = {}
        ...
        logger.info(f"Backend Agent {self.agent_id} initialized with "
    ...
    async def _initialize_capabilities(self):
        ...
        try:
            ...
            logger.info(f"Backend Agent {self.agent_id} capabilities initialized successfully")
                    ...
                    for template_file in type_path.glob("*.json"):
                        try:
                            with open(template_file, 'r') as f:
                                ...
                                self.api_templates[api_type][template_name] = template_data
                        except Exception as e:
                            logger.warning(f"Could not load API template {template_file}: {str(e)}")
                    ...
                    for template_file in type_path.glob("*.json"):
                        try:
                            with open(template_file, 'r') as f:
                                template_data = json.load(f)
                                template_name = template_file.stem
                                self.database_templates[db_type][template_name] = template_data
                        except Exception as e:
                            logger.warning(f"Could not load database template {template_file}: {str(e)}")
                    ...
                    for template_file in type_path.glob("*.json"):
                        try:
                            with open(template_file, 'r') as f:
                                template_data = json.load(f)
                                template_name = template_file.stem
                                self.security_templates[security_type][template_name] = template_data
                        except Exception as e:
                            logger.warning(f"Could not load security template {template_file}: {str(e)}")
                    ...
                    for template_file in type_path.glob("*.json"):
                        try:
                            with open(template_file, 'r') as f:
                                template_data = json.load(f)
                                template_name = template_file.stem
                                self.deployment_templates[deployment_type][template_name] = template_data
                        except Exception as e:
                            logger.warning(f"Could not load deployment template {template_file}: {str(e)}")
    ...
    async def _handle_generate_code_task(self, task) -> Dict[str, Any]:
        ...
        try:
            ...
            if code_type == "api":
                return await self._generate_api_code(language, framework, specification_id)
            elif code_type == "database":
                return await self._generate_database_code(language, framework, specification_id)
            elif code_type == "security":
                return await self._generate_security_code(language, framework, specification_id)
            elif code_type == "deployment":
                return await self._generate_deployment_code(language, framework, specification_id)
            else:
    ...
    async def _generate_api_code(self, language: str, framework: str, specification_id: str) -> Dict[str, Any]:
        """Generate API code for the specified language and framework."""
        try:
            # Get API specification
            if specification_id not in self.api_specifications:
                return {"success": False, "error": f"API specification {specification_id} not found"}
...
'''
    ...
    def _generate_basic_api_code(self, api_spec: APISpecification, language: str, framework: str) -> Dict[str, str]:
    ...
    async def _generate_database_code(self, language: str, framework: str, specification_id: str) -> Dict[str, Any]:
        """Generate database code for the specified language and framework."""
        # TODO: Implement database code generation
        return {"success": False, "error": "Database code generation not yet implemented"}
    
    async def _generate_security_code(self, language: str, framework: str, specification_id: str) -> Dict[str, Any]:
        """Generate security code for the specified language and framework."""
        # TODO: Implement security code generation
        return {"success": False, "error": "Security code generation not yet implemented"}
    
    async def _generate_deployment_code(self, language: str, framework: str, specification_id: str) -> Dict[str, Any]:
        """Generate deployment code for the specified language and framework."""
        # TODO: Implement deployment code generation
        return {"success": False, "error": "Deployment code generation not yet implemented"}
    
    # Public methods for MCP tools
    async def design_api(self, api_type: str, name: str, description: str = "", 
    ...
    async def create_database_schema(self, database_type: str, name: str, description: str = "",
    ...
    async def implement_security(self, security_type: str, name: str, description: str = "",
    ...
    async def design_architecture(self, architecture_type: str, name: str, description: str = "",
                                components: List[Dict[str, Any]] = None,
                                deployment: str = "docker",
                                scaling: Dict[str, Any] = None) -> Dict[str, Any]:
    ...
    async def generate_api_code(self, language: str, framework: str, specification_id: str) -> Dict[str, Any]:
        """Generate API code for the specified language and framework."""
        try:
