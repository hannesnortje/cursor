...
class InMemoryProjectStore:
    ...
    def create_project(self, project_id: str, project_name: str, database_name: str) -> ProjectDatabase:
...
class ProjectDatabaseManager:
    ...
    def create_project_database(self, project_name: str, project_id: str = None) -> ProjectDatabase:
        ...
        if self.fallback_mode:
            return self.in_memory_store.create_project(project_id, project_name, database_name)
