...
def handle_mcp_tool(tool_name: str, arguments: Dict[str, Any], request_id: str, send_response) -> bool:
    ...
    if database_tools.handle_database_tool(tool_name, arguments, request_id, send_response):
        return True
    ...
    if knowledge_tools.handle_knowledge_tool(tool_name, arguments, request_id, send_response):
        return True
