        ...
        },
        {
            ...
            "inputSchema": {
                ...
                "properties": {
                    "project_id": {
                        "type": "string",
                        "description": "Project ID to reset memory for",
                    },
                    "preserve_general_knowledge": {
                        "type": "boolean",
                        "description": "Whether to preserve general knowledge (default: true)",
                    },
                },
                "required": ["project_id"],
            },
        },
        {
            ...
            "inputSchema": {
                ...
                "properties": {
                    "project_id": {
                        "type": "string",
                        "description": "Project ID to archive memory for",
                    }
                },
                "required": ["project_id"],
            },
...
def handle_database_tool(
    ...
    if tool_name == "start_container":
        try:
            ...
            if success:
                send_response(
                    request_id,
                    {
                        "content": [
                            {
                                "type": "text",
                                "text": "Qdrant container started successfully",
                            }
                        ],
                        "structuredContent": {
                            "success": True,
                ...
                send_response(
                    ...
                    {
                        "content": [
                            {"type": "text", "text": "Failed to start Qdrant container"}
                        ],
                        "structuredContent": {
                            "success": False,
        ...
        try:
            ...
            send_response(
                request_id,
                {
                    "content": [
                        {
                            "type": "text",
                            "text": f"Created project database '{project_name}' with ID: {project.project_id}",
                        }
                    ],
                    "structuredContent": {
                        "success": True,
            ...
            send_response(
                request_id,
                error={"code": -32603, "message": f"Error creating database: {str(e)}"},
            )
        return True
        ...
        try:
            ...
            send_response(
                request_id,
                {
                    "content": [
                        {
                            "type": "text",
                            "text": f"Found {len(project_list)} project databases",
                        }
                    ],
                    "structuredContent": {
                        "success": True,
            ...
            send_response(
                request_id,
                error={"code": -32603, "message": f"Error listing databases: {str(e)}"},
            )
        return True
        ...
        try:
            ...
            if success:
                send_response(
                    request_id,
                    {
                        "content": [
                            {
                                "type": "text",
                                "text": f"Switched to project database: {project_id}",
                            }
                        ],
                        "structuredContent": {
                            "success": True,
                ...
                send_response(
                    ...
                    error={
                        "code": -32603,
                        "message": f"Failed to switch to project: {project_id}",
                    },
                )
        except Exception as e:
            send_response(
                ...
                send_response(
                    request_id,
                    {
                        "content": [
                            {
                                "type": "text",
                                "text": f"Archived project database: {project_id}",
                            }
                        ],
                        "structuredContent": {
                            "success": True,
            ...
            send_response(
                request_id,
                {
                    "content": [
                        {
                            "type": "text",
                            "text": f"Restore functionality for project {project_id} - not yet implemented",
                        }
                    ],
                    "structuredContent": {
                        "success": False,
        ...
        try:
                ...
                send_response(
                    request_id,
                    {
                        "content": [
                            {
                                "type": "text",
                                "text": f"Deleted project database: {project_id}",
                            }
                        ],
                        "structuredContent": {
                            "success": True,
            ...
            send_response(
                request_id,
                error={"code": -32603, "message": f"Error deleting database: {str(e)}"},
            )
        return True
        ...
        try:
            ...
            send_response(
                request_id,
                {
                    "content": [
                        {
                            "type": "text",
                            "text": f"Database statistics retrieved successfully",
                        }
                    ],
                    "structuredContent": {
                        "success": True,
            ...
            send_response(
                request_id,
                error={"code": -32603, "message": f"Error getting stats: {str(e)}"},
            )
        return True
        ...
        try:
            ...
            project_id = arguments.get("project_id")
            preserve_general_knowledge = arguments.get(
                "preserve_general_knowledge", True
            )
            ...
            vector_store = get_enhanced_vector_store()
            success = vector_store.reset_project_memory(
                project_id, preserve_general_knowledge
            )
            ...
            if success:
                send_response(
                    request_id,
                    {
                        "content": [
                            {
                                "type": "text",
                                "text": f"Project memory reset for {project_id} (preserved general knowledge: {preserve_general_knowledge})",
                            }
                        ],
                        "structuredContent": {
                            "success": True,
                ...
                send_response(
                    ...
                    error={
                        "code": -32603,
                        "message": f"Failed to reset project memory for: {project_id}",
                    },
                )
        except Exception as e:
            send_response(
                ...
                error={
                    "code": -32603,
                    "message": f"Error resetting project memory: {str(e)}",
                },
            )
        return True
        ...
        try:
            ...
            if success:
                send_response(
                    request_id,
                    {
                        "content": [
                            {
                                "type": "text",
                                "text": f"Project memory archived for {project_id}",
                            }
                        ],
                        "structuredContent": {
                            "success": True,
                ...
                send_response(
                    ...
                    error={
                        "code": -32603,
                        "message": f"Failed to archive project memory for: {project_id}",
                    },
                )
        except Exception as e:
            send_response(
                ...
                error={
                    "code": -32603,
                    "message": f"Error archiving project memory: {str(e)}",
                },
            )
        return True
