    ...
    return [
        ...
        },
        {
            ...
            "inputSchema": {
                ...
                "properties": {
                    ...
                    "domain": {"type": "string", "description": "Optional domain to search within"}
                },
                "required": ["query"]
            }
        },
        ...
        },
        {
            ...
            "inputSchema": {
                ...
                "properties": {
                    ...
                    "domains": {"type": "array", "items": {"type": "string"}, "description": "List of knowledge domains to initialize"}
                },
                "required": ["project_id"]
            }
        },
        {
            ...
            "inputSchema": {
                "type": "object",
                "properties": {
                    "category": {"type": "string", "description": "Knowledge category (methodology, code_quality, security, testing, documentation)"}
                },
                "required": ["category"]
            }
        },
    ...
    if tool_name == "get_domains":
        try:
            ...
            send_response(request_id, {
                "content": [{"type": "text", "text": f"Retrieved {len(domains)} knowledge domains"}],
                "structuredContent": {
                    "success": True,
                    "domains": domains,
            ...
            send_response(request_id, error={"code": -32603, "message": f"Error getting domains: {str(e)}"})
        return True
        ...
        try:
            ...
            if not domain:
                send_response(request_id, error={"code": -32602, "message": "domain is required"})
                return True
            ...
            send_response(request_id, {
                "content": [{"type": "text", "text": f"Retrieved {len(knowledge_items)} knowledge items for domain '{domain}'"}],
                "structuredContent": {
                    "success": True,
                    "domain": domain,
            ...
            send_response(request_id, error={"code": -32603, "message": f"Error getting domain knowledge: {str(e)}"})
        return True
        ...
        try:
            ...
            send_response(request_id, {
                "content": [{"type": "text", "text": f"Retrieved {len(paginated_items)} of {total_items} total knowledge items"}],
                "structuredContent": {
                    "success": True,
            ...
            send_response(request_id, error={"code": -32603, "message": f"Error getting all knowledge: {str(e)}"})
        return True
        ...
        try:
            ...
            send_response(request_id, {
                "content": [{"type": "text", "text": f"Found {len(search_results)} knowledge items matching '{query}'"}],
                "structuredContent": {
                    "success": True,
                    "query": query,
                    "domain": domain,
            ...
            send_response(request_id, error={"code": -32603, "message": f"Error searching knowledge: {str(e)}"})
        return True
        ...
        try:
            ...
            send_response(request_id, {
                "content": [{"type": "text", "text": f"Knowledge base statistics: {stats.get('total_items', 0)} items across {stats.get('total_domains', 0)} domains"}],
                "structuredContent": {
                    "success": True,
                    "statistics": stats
                }
            ...
            send_response(request_id, error={"code": -32603, "message": f"Error getting statistics: {str(e)}"})
        return True
        ...
        try:
            ...
            if result["success"]:
                send_response(request_id, {
                    "content": [{"type": "text", "text": f"Initialized project '{project_id}' with {result['total_items']} knowledge items"}],
                    "structuredContent": {
                        "success": True,
            ...
            send_response(request_id, error={"code": -32603, "message": f"Error initializing project: {str(e)}"})
        return True
        ...
        try:
            ...
            if not category:
                send_response(request_id, error={"code": -32602, "message": "category is required"})
                return True
            ...
            send_response(request_id, {
                "content": [{"type": "text", "text": f"Retrieved {len(category_items)} knowledge items for category '{category}'"}],
                "structuredContent": {
                    "success": True,
                    "category": category,
                    "knowledge_items": items_dict,
            ...
            send_response(request_id, error={"code": -32603, "message": f"Error getting by category: {str(e)}"})
        return True
        ...
        try:
            ...
            if not priority:
                send_response(request_id, error={"code": -32602, "message": "priority is required"})
                return True
            ...
            send_response(request_id, {
                "content": [{"type": "text", "text": f"Retrieved {len(priority_items)} knowledge items with priority '{priority}'"}],
                "structuredContent": {
                    "success": True,
                    "priority": priority,
                    "knowledge_items": items_dict,
            ...
            send_response(request_id, error={"code": -32603, "message": f"Error getting by priority: {str(e)}"})
        return True
