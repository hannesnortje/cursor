...
class RedisMessageQueue:
    ...
    async def dequeue_message(self, queue_name: Optional[str] = None) -> Optional[QueuedMessage]:
    ...
    async def enqueue_offline_message(self, message: QueuedMessage) -> bool:
        ...
        try:
            ...
            logger.info(f"Offline message stored: {message.message_id} for {message.recipient}")
            return True
                    ...
                    if message.recipient == recipient:
                        ...
                        if message.expires_at:
                            ...
                            if current_time > expires_at:
                                ...
                                await self.redis_client.lrem(self.offline_queue, 1, message_data)
                                continue
    ...
    async def get_queue_status(self) -> Dict[str, Any]:
        ...
        try:
            ...
            return {
                ...
                "total_messages": main_queue_size + priority_queue_size + offline_queue_size,
