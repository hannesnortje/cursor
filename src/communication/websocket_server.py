...
class WebSocketServer:
                ...
                try:
                    ...
                    if data.get("type") == "register":
                        ...
                        await websocket.send(json.dumps({
                            "error": "Client must register first",
                            "type": "error"
                        }))
    ...
    async def _handle_register(self, websocket: websockets.WebSocketServerProtocol, data: Dict[str, Any]) -> str:
    ...
    async def _handle_direct_message(self, client_id: str, data: Dict[str, Any]) -> None:
    ...
    async def _handle_status_request(self, client_id: str, data: Dict[str, Any]) -> None:
    ...
    async def send_direct_message(self, message: WebSocketMessage) -> None:
        ...
        if message.recipient in self.clients:
            try:
                ...
                logger.info(f"Direct message sent from {message.sender} to {message.recipient}")
            except Exception as e:
        ...
        # Check if recipient is an agent
            ...
            try:
                ...
                logger.info(f"Direct message sent from {message.sender} to agent {message.recipient}")
            except Exception as e:
