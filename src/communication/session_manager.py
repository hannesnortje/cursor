...
class SessionManager:
    ...
    def create_session(self, session_id: str, chat_type: str, 
                      participants: List[str], metadata: Optional[Dict[str, Any]] = None) -> ChatSessionData:
    ...
    def import_session_data(self, session_data: Dict[str, Any]) -> bool:
        ...
        try:
            ...
            if session.session_id in self.active_sessions:
                logger.warning(f"Session {session.session_id} already exists, skipping import")
                return False
