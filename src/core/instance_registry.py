...
class InstanceRegistry:
    ...
    def __init__(self, registry_file: Optional[Path] = None):
        ...
        """
        self.registry_file = (
            registry_file or Path.home() / ".mcp_instance_registry.json"
        )
    ...
    def _save_registry(self):
        ...
        try:
            ...
            data = {
                "instances": [
                    instance.to_dict() for instance in self.instances.values()
                ],
        ...
        with self.lock:
            ...
            for instance_id, instance in self.instances.items():
                ...
                if (
                    ...
                    and instance.stopped_at
                    and datetime.now() - instance.stopped_at > timedelta(hours=1)
                ):
                    stale_instances.append(instance_id)
    ...
    def register_instance(
        ...
        with self.lock:
            ...
            try:
                ...
                logger.error(
                    f"Failed to allocate ports for instance {instance.instance_id}: {e}"
                )
            ...
            logger.info(
                f"Registered new instance {instance.instance_id} with ports {instance.dashboard_port}, {instance.communication_port}"
            )
            return instance
    ...
    def start_instance(self, instance_id: str, process_id: int) -> bool:
        ...
        return self.update_instance(
            instance_id, process_id=process_id, status=InstanceStatus.RUNNING
        )
    ...
    def stop_instance(self, instance_id: str) -> bool:
        ...
        return self.update_instance(
            instance_id, status=InstanceStatus.STOPPED, stopped_at=datetime.now()
        )
