...
class PortPool:
    ...
    def __init__(self, port_ranges: List[PortRange] = None, state_file: Optional[Path] = None):
        """
    ...
    def _load_state(self):
        ...
        try:
            if self.state_file.exists():
                ...
                logger.info(f"Loaded port state: {len(self.used_ports)} used, {len(self.available_ports)} available")
